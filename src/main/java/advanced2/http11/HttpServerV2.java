...
public class HttpServerV2 implements Runnable {
    private final Socket socket;

    public HttpServerV2(Socket socket) {
        this.socket = socket;
    }
    ...
    private void responseToClient(PrintWriter writer) { // 웹 브라우저에 전달하는 내용
